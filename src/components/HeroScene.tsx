...
export default function HeroScene() {
  return (
    <div className="absolute top-0 left-0 w-full h-full z-0 hidden lg:block pointer-events-none select-none overflow-hidden" aria-label="3D Background Interaction by Nocturne Indonesia">
